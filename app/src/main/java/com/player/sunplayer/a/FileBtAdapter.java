...
/* compiled from: FileBtAdapter */
public class FileBtAdapter extends android.support.v7.widget.RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context a;
    List<File> b;
    b c;
    File d;
    ...
    public FileBtAdapter(Context context, File file) {
        this.a = context;
        if (file.listFiles() != null) {
            this.b = f.b(file.listFiles());
        }
        if (this.b != null) {
            f.a(this.b);
        }
    ...
    public void a(a aVar, final int i) {
        ...
        aVar.a.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (FileBtAdapter.this.c != null) {
                    FileBtAdapter.this.c.a(view, i);
                }
            }
        });
